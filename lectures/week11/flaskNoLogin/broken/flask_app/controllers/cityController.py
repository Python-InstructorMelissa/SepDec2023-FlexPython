...
def allCities():
    ...
    return render_template('allCities.html', user=theUser, cities=theCities)
...
def addCity():
    if 'user_id' not in session:
        ...
        theUser = session['user']
    return render_template('addCity.html', user=theUser)
...
def viewCity(city_id):
    ...
    return render_template('viewCity.html', user=theUser, city=theCity)
